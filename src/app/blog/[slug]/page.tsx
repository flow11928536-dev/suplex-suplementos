...
import { Calendar, Clock, ChevronRight, User, ExternalLink } from 'lucide-react'
          ...
          <div className="prose prose-sm sm:prose-base max-w-none">
            ...
            {post.content.map((section, idx) => {
              if (section.type === 'heading') {
                return <h2 key={idx} className="text-xl sm:text-2xl font-black text-gray-900 mt-8 mb-3">{section.content}</h2>
              }
              if (section.type === 'paragraph') {
                return <p key={idx} className="text-gray-700 leading-relaxed mb-4 text-sm sm:text-base">{section.content}</p>
              }
